	...
	v1 := router.Group("/api/v1")
	{
...

		{
			...
			enrollments := protected.Group("/enrollments")
			{
				...
				enrollments.GET("/student/:student_id", enrollmentHandler.GetStudentEnrollment)
			...
			notifications := protected.Group("/notifications")
			{
				...
				notifications.POST("/broadcast", notificationHandler.BroadcastNotification)
			...
			billing := protected.Group("/billing")
			{
				...
				billing.POST("/invoices/generate", billingHandler.GenerateInvoicesForActiveTerm)
